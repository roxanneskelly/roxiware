...
arrowimages: {down:['downarrowclass', '/assets/icons/down.gif', 23], right:['rightarrowclass', '/assets/icons/right.gif']},
transition: {overtime:50, outtime:100}, //duration of slide in/ out animation, in milliseconds
...
css3support: (getInternetExplorerVersion() >= 9) || (!document.all && document.querySelector), //detect browsers that support CSS3 box shadows (ie9+ or FF3.5+, Safari3+, Chrome etc)
