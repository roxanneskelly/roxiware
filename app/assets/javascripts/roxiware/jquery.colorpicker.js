...
(function ($) {
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			alpha:				true,		// Show alpha controls and mode
			...
			buttonColorize:		true,
			buttonImage:		'/assets/jqcolorpicker/ui-colorpicker.png',
			...
			parts:				'full',			// leave empty for automatic selection
			regional:			'',
		...
		_create: function () {
			...
			if (that.element.is('input') || !that.options.inline) {
				...
				if (that.options.showOn === 'button' || that.options.showOn === 'both') {
					...
					that.button.insertBefore(that.element).click(function () {
