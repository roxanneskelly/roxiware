module Roxiware
    module Blog
        class PostController < ApplicationController
            ...
            # GET /2004/6/my-blog-post
            # Redirect a wordpress/blogger style path to a roxiware style path
            ...
            # GET /blog/2004/8
            # GET /blog/2004
            # show posts for a given date, where a date can specify
            ...
            # GET /blog/2004/7/1/my-blog-title
            def show_by_title
                @enable_blog_edit = true
