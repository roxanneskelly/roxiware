class Roxiware::BookSeries < ActiveRecord::Base
  ...
  edit_attr_accessible :seo_index, :goodreads_id, :description, :image, :large_image, :thumbnail, :title, :as=>[:super, :admin, :user, nil]
  ajax_attr_accessible :seo_index, :goodreads_id, :description, :image, :large_image, :thumbnail, :title, :as=>[:super, :admin, :user, :guest, nil]
